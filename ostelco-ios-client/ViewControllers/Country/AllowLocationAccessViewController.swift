...
class AllowLocationAccessViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        descriptionLabel.setLinkableText(
            LinkableText(
                fullText: NSLocalizedString("To give you mobile data, we have to verify which country you're in", comment: "Explanation for location permissions before user is prompted."),
                linkedPortion: nil
            )!
        )
    }
