...
public struct StageDecider {
    ...
    private func eSIMStage(_ region: RegionDetailsFields, _ localContext: LocalContext) -> StageDecider.Stage {
    ...
    public func compute(context: CustomerQuery.Data.Customer?, localContext: LocalContext) -> Stage {
